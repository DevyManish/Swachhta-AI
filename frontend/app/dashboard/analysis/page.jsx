...
const Page = () => {
  ...
  const renderAnalysisResult = () => {
    ...
    const chartData = Object.entries(predictions).map(([name, value]) => ({
      name,
      value,
    }));
    ...
    return (
      <div className="mt-8 space-y-4">
        <Card>
          ...
          <CardContent>
            <p>
              <strong>Cleanliness Status:</strong> {cleanliness_status}
            </p>
            <p>
              <strong>Image Dimensions:</strong> {image_dimensions.width}x
            ...
            <p>
              <strong>Top Prediction:</strong> {top_prediction.label} (
              {top_prediction.confidence_score.toFixed(2)}%)
            </p>
          </CardContent>
        </Card>
